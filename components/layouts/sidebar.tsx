                        ...
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            <li className="nav-item">
                                <ul>
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/student" className="group">
                                            <div className="flex items-center">
                                                <IconMenuChat className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/seatLayout" className="group">
                                            <div className="flex items-center">
                                                <IconMenuMailbox className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('View Seats')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                    ...
                                    <li className="nav-item">
                                        <Link href="/admin/fees" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Fees')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/admin/inactiveStudents" className="group">
                                            <div className="flex items-center">
                                                <IconMenuScrumboard className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Inactive student')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/admin/enquiry" className="group">
                                            <div className="flex items-center">
